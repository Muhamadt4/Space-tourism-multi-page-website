...
export default function SpaceProjectNav() {
  ...
  const Heads = [
    { number: "00", head: "Home", link: "/Space-tourism-multi-page-website" },
    {
      number: "01",
      head: "Destination",
      link: "/Space-tourism-multi-page-website/Destination",
    },
    {
      number: "02",
      head: "Crew",
      link: "/Space-tourism-multi-page-website/Crew",
    },
    {
      number: "03",
      head: "Technology",
      link: "/Space-tourism-multi-page-website/Technology",
    },
  ];
